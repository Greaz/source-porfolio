...
const caseItems = [
  {name: 'Auchan:Direct', job: 'UI/UX DESIGNER', skills: 'UX, UI, JAVASCRIPT, PROTOTYPES, INTERACTIONS, MOTION DESIGN', baseline: 'Allow users to do their food shopping in less than 20 minutes.', img: 1},
